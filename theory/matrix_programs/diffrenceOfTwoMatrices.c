...
int main()
{
    ...
    int matrixA[rowSize][colSize], matrixB[rowSize][colSize], diffMatrixAB[rowSize][colSize];
    ...
    for (row = 0; row < rowSize; row++)
    {
        ...
        for (col = 0; col < colSize; col++)
        {
            ...
            diffMatrixAB[row][col] = matrixA[row][col] - matrixB[row][col]; // adding the elements right away
        }
    }
